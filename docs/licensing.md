...
Generated Node packages use Node built-ins and have no third-party npm runtime dependencies. Generated PHP packages use the PHP runtime, JSON and cURL extensions and have no third-party Composer runtime dependencies. Optional SQLite inbox examples use the platform's SQLite bindings. Those platforms/extensions and their distributions retain their own licenses.
